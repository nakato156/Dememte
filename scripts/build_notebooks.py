...
# ============================================================================
# Notebook 01 — Baselines (ResNet18 frozen LP + full fine-tune)
# ============================================================================
...
def notebook_01() -> list:
    return [
        md(
            ...
            "",
            "Activa `RUN_TRAINING = True` para entrenar los checkpoints que falten. Si está en `False`,",
            "solo se evalúan checkpoints existentes. Los resultados agregados se escriben en",
            "`out/baseline_summary.csv` y `out/baseline_curves.csv`.",
        ),
        code(*PREAMBLE),
        code(
            "import json, shutil",
            ...
            "",
            "RUN_TRAINING = False  # flip to True to train missing checkpoints",
            "",
        ...
        md("## Entrenamiento/carga + evaluación"),
        code(
            "all_summaries = []",
            "all_curves = []",
            "",
        ...
        md("## Curvas comparativas de robustez"),
        code(
