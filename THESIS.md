...
- **Calibración transversal (C8): RESUELTA (wtq.8).** Era una condición transversal re-medida en
  ...
  de source en los 5 — incluido el caso que antes descontrolaba (CIFAR-100 ECE 0.279→0.100). El
